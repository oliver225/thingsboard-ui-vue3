<template>
  <PageWrapper title="页面水印示例">
    <a-button type="primary" class="mr-2" @click="setWatermark('Hello Thingsboard !')"> 创建水印 1 </a-button>
    <a-button color="error" class="mr-2" @click="clear"> 清理水印 1 </a-button>
    <a-button type="primary" class="mr-2" @click="setWatermark2('https://thingsboard.org')"> 创建水印 2 </a-button>
