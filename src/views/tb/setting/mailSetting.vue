          ...
          <div class="px-4">
            <Row :gutter="24">
              ...
              <Form.Item label="SMTP端口" :name="['jsonValue', 'smtpPort']" :rules="[{ required: true }]">
                <InputNumber v-model:value="formState.jsonValue.smtpPort" :min="1" :max="65535"
                  style="width: calc(90% )" />
              </Form.Item>
              </Col>
              <Col :span="24">
              <Form.Item label="超时时间(毫秒)" :name="['jsonValue', 'timeout']" :rules="[{ required: true }]">
                <InputNumber v-model:value="formState.jsonValue.timeout" :min="0" addonAfter="毫秒"
                  style="width: calc(90% )" />
              </Form.Item>
              </Col>
              <Col :span="24">
              ...
              <Form.Item label="代理端口" :name="['jsonValue', 'proxyPort']" :rules="[{ required: true }]">
                <InputNumber v-model:value="formState.jsonValue.proxyPort" :min="1" :max="65535"
                  style="width: calc(90% )" />
              </Form.Item>
              </Col>
              <Col :span="12" v-if="formState.jsonValue.enableProxy == true">
