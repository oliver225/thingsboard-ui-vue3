    ...
    <BasicTable @register="registerTable">
      ...
      <template #toolbar>
        <Tooltip placement="top">
          ...
          <Icon icon="ant-design:check-circle-outlined" :size="20" @click="handleMarkAllAsRead"
            :style="{ color: 'green' }" />
        </Tooltip>
      </template>
      <template #tableTitle>
...
import { notificationList, deleteNotification, markAllNotificationAsRead, markNotificationAsRead } from '/@/api/tb/notification';
