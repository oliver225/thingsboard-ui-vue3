...
const [registerModal, { setModalProps, closeModal }] = useModalInner(async (data) => {
  ...
  if (NotificationRecipientUsersFilter.TENANT_ADMINISTRATORS == record.value?.configuration?.usersFilter?.type && hasPermission(Authority.SYS_ADMIN)) {
  ...
  updateSchema([
    {
      field: 'configuration.usersFilter.tenantEnable',
      defaultValue: 'tenant',
      ifShow: NotificationRecipientUsersFilter.TENANT_ADMINISTRATORS == record.value?.configuration?.usersFilter?.type && hasPermission(Authority.SYS_ADMIN),
    },
    {
      field: 'configuration.usersFilter.tenantsIds',
