...
<script lang="ts" setup name="AttributeUpdatesTable">
  ...
  const tableConfig = computed(
    (): TableConfig => ({
      title: t('tb.gateway.details.table.attributeUpdates'),
      addButtonText: t('tb.gateway.details.table.addAttributeUpdate'),
      model: props.model,
      defaultData: {
