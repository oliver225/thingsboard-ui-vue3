<template>
  <BasicModal v-bind="$attrs" @register="registerModal" @ok="handleDelete" width="40%" :okButtonProps="{
...
import { TelemetryDelete, deleteEntityTimeseries } from '/@/api/things/telemetry';
