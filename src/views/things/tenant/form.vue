...
<script lang="ts" setup name="TenantForm">
...
import { TenantInfo, tenantInfoById, tenantSave } from '/@/api/things/tenant';
import { tenantProfileInfoList, getTenantProfileInfoDefault } from '/@/api/things/tenantProfile';
