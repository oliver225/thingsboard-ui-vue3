...
<script lang="ts" setup name="TenantAdminForm">
...
import { tenantDashboardList } from '/@/api/things/dashboard';
import { UserInfo } from '/#/store';
import { getActivationLink, getUserById, saveUser } from '/@/api/things/user';
