<template>
    <BasicModal v-bind="$attrs" :footer="null" :can-fullscreen="false" @register="registerModal" width="50%">
        ...
        <div class="border border-neutral-300 rounded-md p-4 mb-4">
            ...
            <template v-if="record.public == true">
                ...
                <div>
                    <CodeEditor v-model:value="embedHtmlCode" :mode="'htmlmixed'" :readonly="true"
        ...
        <div class="border border-neutral-300 rounded-md  p-4 mb-4">
            ...
            <div>
                <CodeEditor v-model:value="embedVueCode" :mode="'htmlmixed'" :readonly="true"
                    class="border border-gray-400" />
            </div>
        </div>
    </BasicModal>
...
import { updateImagePublicStatus } from '/@/api/things/images';
