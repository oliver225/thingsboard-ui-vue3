<template>
    <BasicModal v-bind="$attrs" :showFooter="true" :ok-text="'上传'" :can-fullscreen="false" @register="registerModal"
        @ok="handleSubmit" width="50%">
        <template #title>
        ...
        <Form ref="formRef" :model="formState" layout="vertical">
            <Form.Item name="fileList" :rules="[{ validator: validatorFile }]">
                <Upload.Dragger v-model:fileList="formState.fileList" accept="image/*" list-type="picture" :maxCount="1"
            ...
            <Form.Item v-show="formState.fileList.length > 0" label="标题" name="title"
...
import { uploadImage } from '/@/api/things/images';
