  ...
  <div class="notification-template-list">
    <BasicTable @register="registerTable">
      ...
      <template #deliveryMethods="{ record }">
        <Space>
          <CheckableTag v-for="(method, index) in Object.keys(record.configuration.deliveryMethodsTemplates)"
            :key="index">
            {{ method }}
          </CheckableTag>
        </Space>
...
import { notificationTemplateList, deleteNotificationTemplate } from '/@/api/things/notificationTemplate';
