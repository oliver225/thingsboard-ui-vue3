...
<script lang="ts" setup name="NotificationTemplateForm">
import { Steps, Switch } from 'ant-design-vue';
import { computed, ref, unref, nextTick } from 'vue';
import { NotificationTemplate, getNotificationTemplateById, saveNotificationTemplate } from '/@/api/things/notificationTemplate';
...
const notificationTypeOptions = computed(() => {
  if (userStore.getAuthority == Authority.SYS_ADMIN) {
    return NOTIFICATION_TYPE_OPTIONS.filter(
      item => item.value == NotificationType.GENERAL
