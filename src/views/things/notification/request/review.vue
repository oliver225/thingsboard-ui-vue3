        ...
        <div class="web-container">
          <div class="web-container-body-wrapper">
            <div class="web-container-body">
              <Icon v-if="record.processedTemplates?.WEB?.additionalConfig?.icon?.enabled == true"
              ...
              <div class="web-container-body-content">
                <div v-html="record.processedTemplates?.WEB?.body">
                </div>
              </div>
            </div>
...
<script lang="ts" setup name="NotificationRequestReview">
import { Space, Tag } from 'ant-design-vue';
import { ref } from 'vue';
import { NotificationRequestPreview } from '/@/api/things/notification';
