...
<script lang="ts" setup name="EntityViewAssignToCustomerForm">
...
import { EntityViewInfo, assignEntityViewToCustomer } from '/@/api/things/entityView';
import { customerList, Customer } from '/@/api/things/customer';
