<template>
  <BasicModal :title="'添加键名筛选器'" v-bind="$attrs" @ok="handleSubmit" @register="registerModal" width="70%">
    ...
    <CollapseContainer v-show="showPredicate" title="筛选器" class="border border-neutral-300 mt-4">
...
import { ConditionItem, getAttributesKeys, getTimeseriesKeys } from '/@/api/things/deviceProfile';
