...
<script lang="ts" setup name="AssetForm">
...
import { AssetInfo, getAssetById, saveAsset, } from '/@/api/things/asset';
import { assetProfileList, getDefaultAssetProfileInfo } from '/@/api/things/assetProfile';
