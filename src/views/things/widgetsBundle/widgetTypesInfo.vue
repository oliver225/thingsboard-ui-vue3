...
<script lang="ts" setup name="WidgetTypeInfoList">
...
import { WidgetsBundle, getWidgetsBundleById } from '/@/api/things/widgetsBundle';
import { WidgetType, getBundleWidgetTypesInfos } from '/@/api/things/widgetType';
import { List, Avatar } from 'ant-design-vue';
import { imagePreview } from '/@/api/things/images';
