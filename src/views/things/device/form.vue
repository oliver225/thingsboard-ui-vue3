...
<script lang="ts" setup name="DeviceForm">
...
import { DeviceInfo, getDeviceById, saveDevice, } from '/@/api/things/device';
import { deviceProfileList, getDefaultDeviceProfileInfo } from '/@/api/things/deviceProfile';
...
const inputFormSchemas: FormSchema[] = [
  { field: 'tenantId', component: 'Input', defaultValue: userStore.userInfo?.tenantId, show: false },
...
async function handleSubmit() {
  try {
    ...
    data.customerId = isEmpty(data.customerId.id) ? null : { entityType: EntityType.CUSTOMER, id: data.customerId.id };
