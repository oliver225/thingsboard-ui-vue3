...
import { auditLogList, getAuditLogByUserId, getAuditLogByCustomerId, getAuditLogByEntityId } from '/@/api/things/auditLog';
...
function wrapFetchParams(fetchParam: any) {
  ...
  const actionTypes = fetchParam.actionTypes ? fetchParam.actionTypes.join(',') : null;
