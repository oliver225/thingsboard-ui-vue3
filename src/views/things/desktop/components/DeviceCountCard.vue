  ...
  <Card size="small" title="设备" class="cursor-pointer" @click="go('/device/list')">
    ...
    <Row v-else class="py-4 px-4">
      ...
      <div class="ant-statistic  ">
        <div class="ant-statistic-title mb-1 text-green-600">
          在线
        </div>
      ...
      <Col span="8">
      <div class="ant-statistic ">
        <div class="ant-statistic-title mb-1 text-rose-500">
          离线
        </div>
        <div class="ant-statistic-content">
      ...
      <Col span="8">
      <div class="ant-statistic">
        <div class="ant-statistic-title mb-1">
          全部
        </div>
        <div class="ant-statistic-content">
        ...
        },
        {
          ...
          query: {
            ...
            keyFilters: [{
              ...
              predicate: { operation: "EQUAL", type: "BOOLEAN", value: { defaultValue: true, dynamicValue: null } }
            }]
          }
        },
        {
          ...
          query: {
            ...
            keyFilters: [{
              valueType: "BOOLEAN",
              key: { key: "active", type: "ATTRIBUTE" },
              predicate: { operation: "EQUAL", type: "BOOLEAN", value: { defaultValue: false, dynamicValue: null } }
            }]
          }
        }
      ]
