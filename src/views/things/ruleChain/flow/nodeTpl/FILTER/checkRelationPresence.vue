        ...
        <div class="border  border-neutral-400 p-2 rounded">
            ...
            <div class="p-2">
                ...
                <Form.Item label="关联类型" name="relationType" :rules="[{ required: true, message: '请选择关联类型!' }]">
                    <Select v-model:value="formState.relationType"
                ...
                <Row :gutter="20" v-if="formState.checkForSingleEntity == true">
                    ...
                    <Form.Item label="实体类型" name="entityType">
                        <Select v-model:value="formState.entityType" :options="entityTypeOptions"
                            @change="handleEntityTypeChange"></Select>
                    </Form.Item>
                    </Col>
                    <Col :span="12" v-if="formState.entityType">
                    <Form.Item :label="ENTITY_TYPE_OPTIONS.find(type => type.value == formState.entityType)?.label"
                        name="entityId">
...
import { getTenantAssetList } from '/@/api/things/asset';
import { getTenantEntityViews } from '/@/api/things/entityView';
import { getTenantDeviceList } from '/@/api/things/device';
