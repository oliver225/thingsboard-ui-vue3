<template>
  <BasicDrawer v-bind="$attrs" :showFooter="false" @register="registerDrawer" width="60%">
    ...
    <div class="detail-info-card" v-if="tabActiveKey == 'AUDIT_LOG'">
...
<script lang="ts" setup name="AssetProfileDetail">
...
import { getAssetProfileById, AssetProfile } from '/@/api/things/assetProfile';
