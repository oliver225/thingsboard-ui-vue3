<template>
  <Popover v-model:visible="showPicker" placement="bottomRight" trigger="click" class="ant3-color-picker"
    :class="[colorSize ? 'ant3-color-picker--' + colorSize : '']" v-bind="$attrs">
    <template #content>
