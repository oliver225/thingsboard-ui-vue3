...
export const SUBMIT_STRATEGY_OPTIONS = [
  { value: SubmitStrategyType.SEQUENTIAL_BY_ORIGINATOR, label: '按发起者顺序处理', help: '在确认设备A的前一条消息之前，不会提交设备A的新消息' },
  { value: SubmitStrategyType.SEQUENTIAL_BY_TENANT, label: '按租户顺序处理', help: '在确认租户A的前一条消息之前，不会提交租户A的新消息' },
...
export const PROCESSING_STRATEGY_OPTIONS = [
  { value: ProcessingStrategyType.RETRY_FAILED_AND_TIMED_OUT, label: '失败与超时重试', help: '重试处理包中所有失败和超时的消息' },
  { value: ProcessingStrategyType.SKIP_ALL_FAILURES, label: '跳过所有失败', help: '忽略所有失败' },
  { value: ProcessingStrategyType.SKIP_ALL_FAILURES_AND_TIMED_OUT, label: '跳过所有失败和超时', help: '忽略所有失败和超时' },
