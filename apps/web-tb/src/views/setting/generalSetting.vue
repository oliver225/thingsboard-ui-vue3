...
import { Form, Input, Space, Spin, Switch } from 'ant-design-vue';
...
<template>
  <Spin :spinning="dataLoading">
    <div class="general-setting">
      <div class="my-4 text-lg font-bold">基本设置</div>
      <Form ref="formRef" :model="formState" layout="vertical">
        ...
        >
          <div
            class="rounded-md border border-solid border-neutral-300 px-4 py-3"
          >
            <Switch
              size="small"
