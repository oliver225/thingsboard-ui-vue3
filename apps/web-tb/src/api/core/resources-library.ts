...
export function getResourceListApi(params: ResourceQuery) {
  return requestClient.get<Page<ResourceInfo>>('/resource', { params });
}

export function getTenantResourceListApi(params: ResourceQuery) {
  return requestClient.get<Page<ResourceInfo>>('/resource/tenant', { params });
}

export function getLwm2mListObjectsPageApi(params: BasicQuery) {
  return requestClient.get<[LwM2mObject]>('/resource/lwm2m/page', { params });
}
...
export function getLwm2mListObjectsApi(params: {
  ...
  return requestClient.get<[LwM2mObject]>('/resource/lwm2m', { params });
}

export function saveResourceApi(data?: any | Resource) {
  return requestClient.post<ResourceInfo>('/resource', data);
}
...
export function getResourceInfoByIdApi(resourceId: string) {
  return requestClient.get<ResourceInfo>(`/resource/info/${resourceId}`);
}
...
export function getResourceInfoApi(
  ...
  return requestClient.get<ResourceInfo>(
